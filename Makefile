...
# HEADERS     = -I$(LIBMLX)/include -Isrc
# # Use pkg-config to get proper GLFW flags
# LIBS        = $(LIBMLX)/build/libmlx42.a ./glfw/build/src/libglfw3.a -ldl -pthread -lm
...
# .PHONY: all clean fclean re bonus clone clone_glfw libmlx libglfw
